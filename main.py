...
def run_strategies(ticker, result_list):
    try:
        ...
        lobt = BacktestLongOnly(ticker, data_handler.get_daily_data(), 100000, verbose=False)
        lobt.run_random_forest_strategy_v2(60)
        if lobt.position_change and lobt.position == 1:
...
def run_fundamental_strategies():
...
def main():
    try:
        ...
        for ticker in kospi_tickers :
            ...
            is_good = run_fundamental_strategies(ticker, result_list)
